...
var facts = [
    ...
    "The eldest daughter of former president Barack Obama, Malia Obama, was born on July 4th, Indepdence Day",//8
...
function playAudio(){
    audioPlayButton.src = "TheStarSpangledBanner.mp3";
...
document.getElementById("title").addEventListener("click",function(){
    ...
    flagUp.style.transform = "translateY(-100%)"; //better option
...
monument.addEventListener("click",function(){
    ...
    firework_sound.src = "fireworks.wav";
    firework_sound.play();
    } else {
    factbox.innerHTML = facts[9];
    factbox.style.bottom = "70px";
